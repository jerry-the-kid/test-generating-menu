...
export const SECTION_FRAME =
  'outline outline-2 outline-dashed outline-slate-300 -outline-offset-2 rounded-lg relative bg-white transition-[outline-color,box-shadow] duration-150 hover:outline-slate-400'
export const SECTION_FRAME_SELECTED =
  'outline-blue-500 shadow-[0_0_0_3px_rgba(59,130,246,0.1)]'
export const SECTION_FRAME_DRAGGING = 'opacity-50 outline-blue-500'
export const SECTION_FRAME_LOCKED = 'outline-amber-500 bg-amber-50'
...
export const PANE_CONTAINER =
  'flex-1 [height:min-content] outline outline-1 outline-slate-200 -outline-offset-1 rounded-md min-h-[60px] bg-[#fafbfc] transition-[outline-color,box-shadow] duration-150 cursor-pointer'
export const PANE_CONTAINER_ACTIVE =
  'outline-blue-500 shadow-[0_0_0_2px_rgba(59,130,246,0.15)] bg-blue-50'
...
export const AREA_FRAME_BASE =
  'outline outline-2 -outline-offset-2 rounded-[10px] p-0 relative flex flex-col transition-[outline-color,box-shadow] duration-150'
export const AREA_FRAME_FIXED = 'outline-amber-300 bg-[#fffef5]'
export const AREA_FRAME_LIST = 'outline-blue-400 bg-[#f8fbff] flex-1 min-h-0'
